# 1 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_cbc.fpp"
!>
!! @file m_cbc.f90
...
# 22 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_cbc.fpp" 2
...
# 99 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_cbc.fpp"
...
# 418 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_cbc.fpp"
        if (cbc_dir_in == 1) then
            if (weno_order == 1) then

                fd_coef_x(:, cbc_loc_in) = 0d0
                fd_coef_x(0, cbc_loc_in) = -2d0/(ds(0) + ds(1))
            ...
            elseif (weno_order == 3) then
                ...
                fd_coef_x(:, cbc_loc_in) = 0d0
                fd_coef_x(0, cbc_loc_in) = -6d0/(3d0*ds(0) + 2d0*ds(1) - ds(2))
                fd_coef_x(1, cbc_loc_in) = -4d0*fd_coef_x(0, cbc_loc_in)/3d0
                fd_coef_x(2, cbc_loc_in) = fd_coef_x(0, cbc_loc_in)/3d0
                ...
                fd_coef_x(:, cbc_loc_in) = 0d0
                fd_coef_x(0, cbc_loc_in) = -50d0/(25d0*ds(0) + 2d0*ds(1) &
                                               - 1d1*ds(2) + 1d1*ds(3) &
                                               - 3d0*ds(4))
                fd_coef_x(1, cbc_loc_in) = -48d0*fd_coef_x(0, cbc_loc_in)/25d0
                fd_coef_x(2, cbc_loc_in) = 36d0*fd_coef_x(0, cbc_loc_in)/25d0
                fd_coef_x(3, cbc_loc_in) = -16d0*fd_coef_x(0, cbc_loc_in)/25d0
                fd_coef_x(4, cbc_loc_in) = 3d0*fd_coef_x(0, cbc_loc_in)/25d0
...
# 418 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_cbc.fpp"
        if (cbc_dir_in == 2) then
            if (weno_order == 1) then

                fd_coef_y(:, cbc_loc_in) = 0d0
                fd_coef_y(0, cbc_loc_in) = -2d0/(ds(0) + ds(1))
            ...
            elseif (weno_order == 3) then
                ...
                fd_coef_y(:, cbc_loc_in) = 0d0
                fd_coef_y(0, cbc_loc_in) = -6d0/(3d0*ds(0) + 2d0*ds(1) - ds(2))
                fd_coef_y(1, cbc_loc_in) = -4d0*fd_coef_y(0, cbc_loc_in)/3d0
                fd_coef_y(2, cbc_loc_in) = fd_coef_y(0, cbc_loc_in)/3d0
                ...
                fd_coef_y(:, cbc_loc_in) = 0d0
                fd_coef_y(0, cbc_loc_in) = -50d0/(25d0*ds(0) + 2d0*ds(1) &
                                               - 1d1*ds(2) + 1d1*ds(3) &
                                               - 3d0*ds(4))
                fd_coef_y(1, cbc_loc_in) = -48d0*fd_coef_y(0, cbc_loc_in)/25d0
                fd_coef_y(2, cbc_loc_in) = 36d0*fd_coef_y(0, cbc_loc_in)/25d0
                fd_coef_y(3, cbc_loc_in) = -16d0*fd_coef_y(0, cbc_loc_in)/25d0
                fd_coef_y(4, cbc_loc_in) = 3d0*fd_coef_y(0, cbc_loc_in)/25d0
...
# 418 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_cbc.fpp"
        if (cbc_dir_in == 3) then
            if (weno_order == 1) then

                fd_coef_z(:, cbc_loc_in) = 0d0
                fd_coef_z(0, cbc_loc_in) = -2d0/(ds(0) + ds(1))
            ...
            elseif (weno_order == 3) then
                ...
                fd_coef_z(:, cbc_loc_in) = 0d0
                fd_coef_z(0, cbc_loc_in) = -6d0/(3d0*ds(0) + 2d0*ds(1) - ds(2))
                fd_coef_z(1, cbc_loc_in) = -4d0*fd_coef_z(0, cbc_loc_in)/3d0
                fd_coef_z(2, cbc_loc_in) = fd_coef_z(0, cbc_loc_in)/3d0
                ...
                fd_coef_z(:, cbc_loc_in) = 0d0
                fd_coef_z(0, cbc_loc_in) = -50d0/(25d0*ds(0) + 2d0*ds(1) &
                                               - 1d1*ds(2) + 1d1*ds(3) &
                                               - 3d0*ds(4))
                fd_coef_z(1, cbc_loc_in) = -48d0*fd_coef_z(0, cbc_loc_in)/25d0
                fd_coef_z(2, cbc_loc_in) = 36d0*fd_coef_z(0, cbc_loc_in)/25d0
                fd_coef_z(3, cbc_loc_in) = -16d0*fd_coef_z(0, cbc_loc_in)/25d0
                fd_coef_z(4, cbc_loc_in) = 3d0*fd_coef_z(0, cbc_loc_in)/25d0
...
# 487 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_cbc.fpp"
...
# 639 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_cbc.fpp"
        if (cbc_dir == 1) then
...
# 961 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_cbc.fpp"
...
# 1458 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_cbc.fpp"
...
# 1462 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_cbc.fpp"
