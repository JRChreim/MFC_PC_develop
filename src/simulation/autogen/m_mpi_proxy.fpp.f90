# 1 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp"
!>
...
# 6 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp" 2
...
# 7 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp" 2
    ...
    subroutine s_initialize_mpi_proxy_module() ! ---------------------------
        ...
        if(qbmm .and. .not. polytropic) then
            if (n > 0) then
                if (p > 0) then
#ifdef MFC_DEBUG
# 70 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp"
    block
# 70 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp"
...
# 70 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp"
        print *, 'm_mpi_proxy.fpp:70: ', '@:ALLOCATE(q_cons_buff_send(0:-1 + buff_size*(sys_size + 2*nb*4)* (m + 2*buff_size + 1)* (n + 2*buff_size + 1)* (p + 2*buff_size + 1)/ (min(m, n, p) + 2*buff_size + 1)))'
# 70 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp"
...
#endif
# 70 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp"
    allocate(q_cons_buff_send(0:-1 + buff_size*(sys_size + 2*nb*4)*  (m + 2*buff_size + 1)*  (n + 2*buff_size + 1)*  (p + 2*buff_size + 1)/  (min(m, n, p) + 2*buff_size + 1)))
# 70 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp"
    !$acc enter data create(q_cons_buff_send(0:-1 + buff_size*(sys_size + 2*nb*4)*  (m + 2*buff_size + 1)*  (n + 2*buff_size + 1)*  (p + 2*buff_size + 1)/  (min(m, n, p) + 2*buff_size + 1)))
# 75 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp"
                else
#ifdef MFC_DEBUG
# 76 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp"
    block
# 76 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp"
        use iso_fortran_env, only: output_unit
# 76 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp"
...
# 76 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp"
        print *, 'm_mpi_proxy.fpp:76: ', '@:ALLOCATE(q_cons_buff_send(0:-1 + buff_size*(sys_size + 2*nb*4)* (max(m, n) + 2*buff_size + 1)))'
# 76 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp"
        call flush(output_unit)
# 76 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp"
    end block
...
#endif
# 76 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp"
    allocate(q_cons_buff_send(0:-1 + buff_size*(sys_size + 2*nb*4)*  (max(m, n) + 2*buff_size + 1)))
# 76 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp"
    !$acc enter data create(q_cons_buff_send(0:-1 + buff_size*(sys_size + 2*nb*4)*  (max(m, n) + 2*buff_size + 1)))
# 78 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp"
                end if
            else
#ifdef MFC_DEBUG
# 80 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp"
    block
# 80 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp"
        use iso_fortran_env, only: output_unit
# 80 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp"
...
# 80 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp"
        print *, 'm_mpi_proxy.fpp:80: ', '@:ALLOCATE(q_cons_buff_send(0:-1 + buff_size*(sys_size + 2*nb*4)))'
# 80 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp"
        call flush(output_unit)
# 80 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp"
    end block
...
# 80 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp"
    !$acc enter data create(q_cons_buff_send(0:-1 + buff_size*(sys_size + 2*nb*4)))
            end if

#ifdef MFC_DEBUG
# 83 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp"
    block
# 83 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp"
        use iso_fortran_env, only: output_unit
# 83 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp"
...
# 83 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp"
        print *, 'm_mpi_proxy.fpp:83: ', '@:ALLOCATE(q_cons_buff_recv(0:ubound(q_cons_buff_send, 1)))'
# 83 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp"
        call flush(output_unit)
# 83 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp"
    end block
...
# 83 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp"
    !$acc enter data create(q_cons_buff_recv(0:ubound(q_cons_buff_send, 1)))
            ...
            if (n > 0) then
                if (p > 0) then
#ifdef MFC_DEBUG
# 89 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp"
    block
# 89 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp"
        use iso_fortran_env, only: output_unit
# 89 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp"
...
# 89 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp"
        print *, 'm_mpi_proxy.fpp:89: ', '@:ALLOCATE(q_cons_buff_send(0:-1 + buff_size*sys_size* (m + 2*buff_size + 1)* (n + 2*buff_size + 1)* (p + 2*buff_size + 1)/ (min(m, n, p) + 2*buff_size + 1)))'
# 89 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp"
        call flush(output_unit)
# 89 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp"
    end block
...
#endif
# 89 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp"
    allocate(q_cons_buff_send(0:-1 + buff_size*sys_size*  (m + 2*buff_size + 1)*  (n + 2*buff_size + 1)*  (p + 2*buff_size + 1)/  (min(m, n, p) + 2*buff_size + 1)))
# 89 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp"
...
# 94 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp"
                else
#ifdef MFC_DEBUG
# 95 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp"
    block
# 95 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp"
        use iso_fortran_env, only: output_unit
# 95 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp"
...
# 95 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp"
        print *, 'm_mpi_proxy.fpp:95: ', '@:ALLOCATE(q_cons_buff_send(0:-1 + buff_size*sys_size* (max(m, n) + 2*buff_size + 1)))'
# 95 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp"
        call flush(output_unit)
# 95 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp"
    end block
...
# 97 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp"
                end if
            else
#ifdef MFC_DEBUG
# 99 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp"
    block
# 99 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp"
        use iso_fortran_env, only: output_unit
# 99 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp"
...
# 99 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp"
        print *, 'm_mpi_proxy.fpp:99: ', '@:ALLOCATE(q_cons_buff_send(0:-1 + buff_size*sys_size))'
# 99 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp"
        call flush(output_unit)
# 99 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp"
    end block
...
#ifdef MFC_DEBUG
# 102 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp"
    block
# 102 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp"
        use iso_fortran_env, only: output_unit
# 102 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp"
...
# 102 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp"
        print *, 'm_mpi_proxy.fpp:102: ', '@:ALLOCATE(q_cons_buff_recv(0:ubound(q_cons_buff_send, 1)))'
# 102 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp"
        call flush(output_unit)
# 102 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp"
    end block
...
# 131 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp"
...
# 133 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp"

# 140 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp"
...
# 140 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp"
            call MPI_BCAST(weno_avg, 1, MPI_LOGICAL, 0, MPI_COMM_WORLD, ierr)
# 140 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp"
            call MPI_BCAST(relax, 1, MPI_LOGICAL, 0, MPI_COMM_WORLD, ierr)
# 142 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp"

# 145 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp"
...
# 147 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp"

# 149 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp"
            call MPI_BCAST(weno_order, 1, MPI_INTEGER, 0, MPI_COMM_WORLD, ierr)
            call MPI_BCAST(nb, 1, MPI_INTEGER, 0, MPI_COMM_WORLD, ierr)
# 152 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp"

        do i = 1, num_fluids_max
# 156 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp"
...
# 158 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp"
...
# 168 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp"
...
# 170 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp"

# 172 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp"
...
# 174 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp"

# 176 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp"
...
# 178 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp"
        end do
...
#ifdef MFC_DEBUG
# 2422 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp"
    block
# 2422 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp"
        use iso_fortran_env, only: output_unit
# 2422 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp"
...
# 2422 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp"
        print *, 'm_mpi_proxy.fpp:2422: ', '@:DEALLOCATE(q_cons_buff_send, q_cons_buff_recv)'
# 2422 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp"
        call flush(output_unit)
# 2422 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_mpi_proxy.fpp"
    end block
