# 1 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_riemann_solvers.fpp"
!>
...
!!                  3) Exact
# 1 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/include/inline_riemann.fpp" 1
# 15 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/include/inline_riemann.fpp"


# 37 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/include/inline_riemann.fpp"

# 49 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/include/inline_riemann.fpp"

# 21 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_riemann_solvers.fpp" 2
# 1 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/common/include/inline_conversions.fpp" 1
# 55 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/common/include/inline_conversions.fpp"

# 22 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_riemann_solvers.fpp" 2
...
contains
    ...
    subroutine s_hll_riemann_solver(qL_prim_rsx_vf, qL_prim_rsy_vf, qL_prim_rsz_vf, dqL_prim_dx_vf, & ! -------
        ...
        call s_initialize_riemann_solver( &
            ...
            flux_gsrc_vf, &
            norm_dir, ix, iy, iz)
# 306 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_riemann_solvers.fpp"
...
# 458 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_riemann_solvers.fpp"
if (avg_state == 1) then
# 458 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_riemann_solvers.fpp"
...
# 694 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_riemann_solvers.fpp"
...
# 860 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_riemann_solvers.fpp"
...
# 980 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_riemann_solvers.fpp"
if (avg_state == 1) then
# 980 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_riemann_solvers.fpp"
    rho_avg = sqrt(rho_L*rho_R)
# 980 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_riemann_solvers.fpp"
                                ...
                                if (s_L >= 0d0) then
                                    ...
                                    do i = 1, num_fluids
                                        ...
                                        flux_rsx_vf(j, k, l, i + intxb - 1) = &
                                            ...
                                            qL_prim_rsx_vf(j, k, l, i + contxb - 1) * &
                                    ...
                                    do i = 1, num_fluids
                                        ...
                                        flux_rsx_vf(j, k, l, i + intxb - 1) = &
                                            ...
                                            ( gammas(i)*pres_R + pi_infs(i) ) + &
                                              qR_prim_rsx_vf(j + 1, k, l, i + contxb - 1) * &
...
# 1259 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_riemann_solvers.fpp"
if (avg_state == 1) then
# 1259 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_riemann_solvers.fpp"
    rho_avg = sqrt(rho_L*rho_R)
# 1259 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_riemann_solvers.fpp"
...
# 1419 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_riemann_solvers.fpp"
# 1439 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_riemann_solvers.fpp"
                            end do
                        end do
                    end do
                    ...
                    do l = is3%beg, is3%end
                        do k = is2%beg, is2%end
                            do j = is1%beg, is1%end
                                ...
                                if (any(Re_size > 0)) then
                                    if (num_fluids == 1) then ! Need to consider case with num_fluids >= 2
                                        ...
                                        do i = 1, 2
                                            ...
                                            !$acc loop seq
                                            do q = 1, Re_size(i)
                                                Re_L(i) = (1d0-qL_prim_rsx_vf(j, k, l, E_idx + Re_idx(i, q)))/Res(i, q) &
                                                        + Re_L(i)
                                            end do
                                        ...
                                        do i = 1, 2
                                            ...
                                            !$acc loop seq
                                            do q = 1, Re_size(i)
                                                Re_R(i) = (1d0-qR_prim_rsx_vf(j + 1, k, l, E_idx + Re_idx(i, q)))/Res(i, q) &
                                                        + Re_R(i)
                                            end do
                                ...
                                ! Geometrical source flux for cylindrical coordinates
# 1861 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_riemann_solvers.fpp"
# 1883 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_riemann_solvers.fpp"
                            end do
                        end do
                    end do
...
# 2006 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_riemann_solvers.fpp"
if (avg_state == 1) then
# 2006 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_riemann_solvers.fpp"
    rho_avg = sqrt(rho_L*rho_R)
# 2006 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_riemann_solvers.fpp"
...
# 2173 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_riemann_solvers.fpp"
# 2195 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_riemann_solvers.fpp"
                            end do
                        end do
                    end do
                end if
                                ...
                                if (s_L >= 0d0) then
                                    ...
                                    do i = 1, num_fluids
                                        ...
                                        flux_rsy_vf(j, k, l, i + intxb - 1) = &
                                            ...
                                            ( gammas(i)*pres_L + pi_infs(i) ) + &
                                            qL_prim_rsy_vf(j, k, l, i + contxb - 1) * &
                                            qvs(i) ) * vel_L(dir_idx(1) )
                                    end do
                                    !$acc loop seq
                                    do i = 1, num_dims
                                    ...
                                    do i = 1, num_fluids
                                        ...
                                        flux_rsy_vf(j, k, l, i + intxb - 1) = &
                                            ...
                                            ( gammas(i)*pres_R + pi_infs(i) ) + &
                                              qR_prim_rsy_vf(j + 1, k, l, i + contxb - 1) * &
                                            qvs(i) ) * vel_R(dir_idx(1))
                                    end do
                                    !$acc loop seq
                                    do i = 1, num_dims
...
# 1394 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_riemann_solvers.fpp"
                                    if (cyl_coord) then
                                        ! Substituting the advective flux into the inviscid geometrical source flux
                                        !$acc loop seq
                                        do i = 1, E_idx
                    ...
                    do l = is3%beg, is3%end
                        do k = is2%beg, is2%end
                            do j = is1%beg, is1%end
                                ...
                                if (any(Re_size > 0)) then
                                    if (num_fluids == 1) then ! Need to consider case with num_fluids >= 2
                                        ...
                                        do i = 1, 2
                                            ...
                                            !$acc loop seq
                                            do q = 1, Re_size(i)
                                                Re_L(i) = (1d0-qL_prim_rsy_vf(j, k, l, E_idx + Re_idx(i, q)))/Res(i, q) &
                                                        + Re_L(i)
                                            end do
                                        ...
                                        do i = 1, 2
                                            ...
                                            !$acc loop seq
                                            do q = 1, Re_size(i)
                                                Re_R(i) = (1d0-qR_prim_rsy_vf(j + 1, k, l, E_idx + Re_idx(i, q)))/Res(i, q) &
                                                        + Re_R(i)
                                            end do
                                ...
                                ! Geometrical source flux for cylindrical coordinates
# 1836 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_riemann_solvers.fpp"
                                    if (cyl_coord) then
                                        ! Substituting the advective flux into the inviscid geometrical source flux
                                        !$acc loop seq
                                        do i = 1, E_idx
...
# 2148 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_riemann_solvers.fpp"
                                    if (cyl_coord) then
                                        !Substituting the advective flux into the inviscid geometrical source flux
                                        !$acc loop seq
                                        do i = 1, E_idx
                                ...
                                if (s_L >= 0d0) then
                                    ...
                                    do i = 1, num_fluids
                                        ...
                                        flux_rsz_vf(j, k, l, i + intxb - 1) = &
                                            ...
                                            ( gammas(i)*pres_L + pi_infs(i) ) + &
                                            qL_prim_rsz_vf(j, k, l, i + contxb - 1) * &
                                            qvs(i) ) * vel_L(dir_idx(1) )
                                    end do
                                    !$acc loop seq
                                    do i = 1, num_dims
                                    ...
                                    do i = 1, num_fluids
                                        ...
                                        flux_rsz_vf(j, k, l, i + intxb - 1) = &
                                            ...
                                            ( gammas(i)*pres_R + pi_infs(i) ) + &
                                              qR_prim_rsz_vf(j + 1, k, l, i + contxb - 1) * &
                                            qvs(i) ) * vel_R(dir_idx(1))
                                    end do
                                    !$acc loop seq
                                    do i = 1, num_dims
...
# 1419 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_riemann_solvers.fpp"
# 1420 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_riemann_solvers.fpp"
                    ...
                    do l = is3%beg, is3%end
                        do k = is2%beg, is2%end
                            do j = is1%beg, is1%end
                                ...
                                if (any(Re_size > 0)) then
                                    if (num_fluids == 1) then ! Need to consider case with num_fluids >= 2
                                        ...
                                        do i = 1, 2
                                            ...
                                            !$acc loop seq
                                            do q = 1, Re_size(i)
                                                Re_L(i) = (1d0-qL_prim_rsz_vf(j, k, l, E_idx + Re_idx(i, q)))/Res(i, q) &
                                                        + Re_L(i)
                                            end do
                                        ...
                                        do i = 1, 2
                                            ...
                                            !$acc loop seq
                                            do q = 1, Re_size(i)
                                                Re_R(i) = (1d0-qR_prim_rsz_vf(j + 1, k, l, E_idx + Re_idx(i, q)))/Res(i, q) &
                                                        + Re_R(i)
                                            end do
                                ...
                                ! Geometrical source flux for cylindrical coordinates
# 1861 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_riemann_solvers.fpp"
# 1862 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_riemann_solvers.fpp"
                                    if (grid_geometry == 3) then
                                        !$acc loop seq
                                        do i = 1, sys_size
                                            flux_gsrc_rsz_vf(j, k, l, i) = 0d0
...
# 2173 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_riemann_solvers.fpp"
# 2174 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_riemann_solvers.fpp"
                                    if (grid_geometry == 3) then
                                        !$acc loop seq
                                        do i = 1, sys_size
                                            flux_gsrc_rsz_vf(j, k, l, i) = 0d0
...
# 2201 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_riemann_solvers.fpp"
...
# 3911 "/ocean/projects/phy230019p/jrchreim/MFC-JRChreim/src/simulation/m_riemann_solvers.fpp"
